...
function Cart() {
  ...
  function myFunction() {
    Swal.fire({
      title: 'Are you sure you want to conform your order?',
      showDenyButton: true,
      showCancelButton: true,
      confirmButtonText: 'Conform',
      denyButtonText: `Don't Conform`,
    }).then((result) => {
      if (result.isConfirmed) {
        Swal.fire('Order Conform!', '', 'success')
        setTimeout(() => {
  ...
  return (
    ...
    <div>
      ...
      <button className='btn btn-dark' onClick={myFunction}>Conform Order</button>
      <span />
