    ...
    return (
        ...
        <div>
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style={{ padding: "20px" }}>
                ...
                <a class="navbar-brand" style={{ fontFamily: "monospace" }}>Medicine Information App</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto" style={{ fontFamily: "monospace" }}>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="Userlist">MedicineList</a>
                        </li>
                        <li class="nav-item">
                    ...
                    {user.map((user, index) => (
                        <Grid item key={user.id} xs={12} md={6} lg={4}>
                            <NoteCard note={user} key={index}
                                item={user} handleclick={deleteuser} additem={addcart} />
